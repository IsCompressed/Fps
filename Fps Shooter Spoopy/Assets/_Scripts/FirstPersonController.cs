...
public class FirstPersonController : MonoBehaviour
{
    ...
    public float maxVelocityChange = 4.5f;
    ...
    public float crouchHeight = 0.5f; // Percentage of original height
    public float speedReduction = 0.5f; // Percentage of speed reduction
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            // Normalize the targetVelocity to prevent faster diagonal movement
            ...
            if (enableSprint && Input.GetKey(sprintKey) && sprintRemaining > 0f && !isSprintCooldown)
            {
                ...
                if (velocityChange.x != 0 || velocityChange.z != 0)
                {
                    ...
                    if (isCrouched)
                    {
                        StandUp(); // Automatically stand up when sprinting
                    }
    ...
    private void Crouch()
    {
        if (!isCrouched)
        {
            ...
            playerCollider.height = originalHeight * crouchHeight;
            playerCollider.center = new Vector3(originalCenter.x, originalCenter.y * crouchHeight, originalCenter.z);
